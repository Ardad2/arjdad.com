    ...
    <section id="about" className="rounded-full">
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center ">
          ...
          I'm currently a <b>first-year Computer Science PhD student at Tulane University</b>, working as a <b>Research Assistant</b> under the supervision of <b>Prof. Brian Summa</b>.
          
          </p>

          <p className="mb-8 leading-relaxed">
          
          I graduated from <b>Arizona State University</b> (ASU) with an <b>accelerated 4+1 Master’s degree in Computer Science</b> with a specialization in <b>Artificial Intelligence</b> in May 2025. 
